...
knitr::knit_hooks$set(output = chunk_class)
...
```{r show-code,  echo=T, eval=F, hlopts=list(hl_lines= paste0('[', 2,',', "3-5", ']'))}
...
```{python, echo=T,  eval=F, hlopts=list(hl_lines= paste0('[', 2,',',3, ',', 4,']'), language = 'python'), engine.path = '/usr/bin/python3'}
