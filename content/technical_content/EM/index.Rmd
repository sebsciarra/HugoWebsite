...
#pandoc content/technical_content/EM/refs.bib -t csljson -o content/technical_content/EM/refs.json
```
...
```{python lower-equal-incomplete, echo=T, eval=T, results = 'hold',  class_name = 'python-code', hlopts=list(language = 'python')}
import numpy as np
import pandas as pd
...
```{python lower-bound-increase, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
...
```{python incomplete-data-increase, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
