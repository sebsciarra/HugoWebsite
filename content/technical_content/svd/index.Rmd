...
```{python modules-packages, eval=T, echo=T,  class_name = 'python-code', hlopts=list(language = 'python')}
import math 
import numpy as np
import pandas as pd
...
```{python projection, echo=T, eval=F,  class_name = 'python-code', hlopts=list(language = 'python')}
# Define vectors
x = np.array([3, 3])
v = np.array([1, 3])
...
```{r wine-drinker-code, echo=T, eval=F}
library(tidyverse)
library(Matrix)
...
```{python singular-eigenvalue, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
...
```{python number-pca, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
...
```{python variable-loadings, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
...
```{python matrix-loadings, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
...
```{r loading-table, echo=T, eval=T, results = 'hold'}
...
```{python rotation-indeterminacy, echo=T, eval=F,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# add colors
...
```{python rotation-indeterminacy-ex, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
...
```{python varimax, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# compute four different rotated loadings
varimax = Rotator(method="varimax")
varimax_loadings = varimax.fit_transform(pca_loadings)
...
```{r varimax-table, echo=T, eval=T, results = 'hold'}
...
```{python varimax-plot, echo=T, eval=F,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# add colors
...
```{python unrotated-pca-scores, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
...
```{python scaled-pca-scores, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
...
```{python loadings-orthogonal, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
...
```{python rotated-pca-scores, echo=T, eval=F,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
...
```{python biplot, echo=T, eval=T,  class_name = 'python-code', results = 'hold', hlopts=list(language = 'python')}
# standardize data
df_std = (A - A.mean())/A.std(ddof=1)
