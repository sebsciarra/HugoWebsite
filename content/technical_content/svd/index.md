...
cor(A) %>% round(2)
```
<pre><code class=''>          Cab.Sauv. Merlot Malbec Champagne  Rose
Cab.Sauv.      1.00   1.00   1.00     -0.98 -1.00
Merlot         1.00   1.00   1.00     -0.99 -1.00
Malbec         1.00   1.00   1.00     -0.99 -1.00
Champagne     -0.98  -0.99  -0.99      1.00  0.98
Rose          -1.00  -1.00  -1.00      0.98  1.00
</code></pre>```r 
# standardize 
...
summary(pca_result)
```
<pre><code class=''>Importance of components:
                          PC1     PC2     PC3     PC4     PC5
Standard deviation     2.2302 0.14272 0.06576 0.03192 0.02456
Proportion of Variance 0.9947 0.00407 0.00086 0.00020 0.00012
Cumulative Proportion  0.9947 0.99881 0.99968 0.99988 1.00000
</code></pre>
