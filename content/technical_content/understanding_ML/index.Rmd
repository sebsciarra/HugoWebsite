...
```{python contrained-erm, eval=F, echo=T,  class_name = 'python-code', hlopts=list(language = 'python')}
...
mult_trunc_data2 = generate_mult_trunc_normal(cov_matrix = cov_matrix, mu = mu, sd = sd, 
                                             rho = rho_weather_winemaking, sample_size = sample_size)


compute_bayes_risk(data_test=mult_trunc_data)
```

## Optimization Error: The Result of Imperfect Optimization


```{python ERM-failure, eval=F,  class_name = 'python-code', hlopts=list(language = 'python')}
import pandas as pd
