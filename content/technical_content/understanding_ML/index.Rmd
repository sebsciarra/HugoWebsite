...
With an understanding of the behaviour of bias, variance, and noise, it is now possible to deduce rules of supervised machine learning. In Figure \ref{fig:bias-var-rules}, I show the pattern of empirical loss (light blue line) and generalization error (dark blue line) as a function of the sample size used for model development.  
