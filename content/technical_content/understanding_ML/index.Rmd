...
With an understanding of the behaviour of bias, variance, and noise, it is now possible to deduce rules of supervised machine learning. In Figure \ref{fig:bias-var-rules}, I show two general patterns of empirical loss (light blue line) and generalization error (dark blue line) as a function of the sample size used for model development.  
...
<div class="figure">
  <div class="figDivLabel">
   ...
   <div class="figTitle">
    ...
    <img src="images/plot_high_variance.png" width="80%" height="80%"> 
...
cols_to_expand = df_emp_gen_error_curve.columns[1:5]
...
split_cols = df_emp_gen_error_curve_long['error_type'].str.extract(pattern)

#Create two new columns 
df_emp_gen_error_curve_long["error_type"] = split_cols[0]
df_emp_gen_error_curve_long["problem"] = split_cols[1]
...
df_emp_gen_error_curve_long$problem <- factor(
  ...
  labels = c("bold(A:~Error~Patterns~Caused~by~High~Variance~(Overfitting))",
             "bold(B:~Error~Patterns~Caused~by~High~Bias~(Underfitting))"))
...
plot_bias_var_rules <- ggplot(data = df_emp_gen_error_curve_long, 
  ...
  geom_text(inherit.aes = F, data = df_text_merged, 
