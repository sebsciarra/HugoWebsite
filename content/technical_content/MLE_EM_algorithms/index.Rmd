...
and cannot be interpreted as such. As an example, the likelihood of 0.108 obtained for $P(h=7, n=10|\theta = .50)$ does not mean that, given a probability of heads of .50, there is a 10.8% chance that seven heads will arise in 10 coin flips. In full truth, the value of 0.108 by itself means very little


## Using Likelihood Distribution to Determine the Parameter Value that Most Likely Produced the Observed Data
